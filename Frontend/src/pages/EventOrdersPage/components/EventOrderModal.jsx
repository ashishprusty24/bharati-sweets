...
import { Modal, Form, Input, InputNumber, Select, AutoComplete, Row, Col, DatePicker, Button, Divider, Grid, Switch, Typography } from "antd";
    ...
    >
      <Form form={form} layout="vertical">
        ...
        <Form.Item name="address" label="Delivery Address" rules={[{ required: true, message: "Required" }]}>
          <Input.TextArea rows={2} placeholder="Delivery address where this event order is to be delivered" />
        </Form.Item>
