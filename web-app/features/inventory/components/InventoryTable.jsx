  ...
  const columns = [
    {
      ...
      dataIndex: "name",
      key: "name",
      render: (text) => <Text strong style={{ fontSize: 15, color: "#10b981" }}>{text}</Text>,
    },
    {
      title: "Category",
      dataIndex: "category",
    ...
    },
    {
      ...
      render: (qty, record) => (
        <Space direction="vertical" size={0}>
          ...
          <Text type="secondary" style={{ fontSize: 11 }}>Min: {record.minStock || record.minThreshold || 5} {record.unit}</Text>
        </Space>
      ),
    },
    {
      ...
      key: "cost",
      render: (cost, record) => <Text strong>₹{cost || record.price || 0}</Text>,
      responsive: ["md"],
    },
    {
      title: "Status",
      key: "status",
      render: (_, record) => getStatusTag(record.quantity, record.minStock || record.minThreshold || 5),
    },
    {
      title: "Actions",
      key: "actions",
